...
const CATS = ['ALL', 'FAV', 'CURRENCIES', 'CRYPTO', 'METALS', 'INDICES'] as const;

function Row({ a, active, onPick }: { key?: string; a: AssetRow; active: boolean; onPick: () => void }) {
...
export function Watchlist() {
  ...
  const filtered = assets.filter((a) => {
    ...
    if (cat === 'CURRENCIES' && !(a.category === 'CURRENCIES' || a.category === 'FOREX')) return false;
    if (cat !== 'ALL' && cat !== 'FAV' && cat !== 'CURRENCIES' && a.category !== cat) return false;
